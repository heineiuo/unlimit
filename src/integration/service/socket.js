 ...
 * @returns {Promise}
 */
Socket.empty = () =>  new Promise(async (resolve, reject) => {
  try {
...
Socket.findAll = () => new Promise(async (resolve, reject) => {
  try {
 ...
 * delete socket
 */
Socket.delete = (socketId) => new Promise(async (resolve, reject) => {
  try {
 ...
 * @returns {Promise}
 */
Socket.detail = (socketId) => new Promise(async (resolve, reject) => {
  try {
 ...
 * @returns {Promise}
 */
Socket.findByAppId = (appId) => new Promise(async (resolve, reject) => {
  try {
 ...
 * @returns {Promise}
 */
Socket.bindApp = (socketId, registerInfo) =>  new Promise(async (resolve, reject) => {
  try {
 ...
 * 获取处理请求的app, 并作负载均衡
 */
Socket.balance = (importAppName) => new Promise(async (resolve, reject) => {
  try {
